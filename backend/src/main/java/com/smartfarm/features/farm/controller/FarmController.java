...
public class FarmController {
    ...
    @PostMapping("/{id}/geofence-check")
    public ApiResponse<GeofenceResponse> checkGeofenceForFarm(
            @PathVariable UUID id,
            @Valid @RequestBody GeofenceRequest request) {
        GeofenceResponse response = geofenceService.checkGeofenceForFarm(id, request.getLatitude(), request.getLongitude());
        return ApiResponse.success(response);
    }

    @PostMapping("/geofence-check")
    public ApiResponse<GeofenceResponse> checkGeofenceForBoundary(
            @Valid @RequestBody GeofenceRequest request) {
