...
public class AuthService {
    ...
    public Map<String, Object> register(RegisterRequest request, String ipAddress) {
        ...
        String fullName = request.getFullName() != null && !request.getFullName().isBlank()
                ...
                : ((request.getFirstName() != null ? request.getFirstName().trim() : "") + " " + (request.getLastName() != null ? request.getLastName().trim() : "")).trim();
        ...
        User user = User.builder()
                .firstName(firstName)
                .lastName(lastName)
                .name(fullName.isBlank() ? username : fullName)
                .username(username)
                .email(email)
                .phone(phone)
                .passwordHash(encodedPassword)
                .role(assignedRole != null ? assignedRole : Role.FARM_OWNER)
