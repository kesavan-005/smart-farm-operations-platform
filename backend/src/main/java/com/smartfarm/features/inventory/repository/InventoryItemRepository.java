...
public interface InventoryItemRepository extends JpaRepository<InventoryItem, UUID> {
    ...
    List<InventoryItem> findByFarmIdAndStatus(UUID farmId, String status);
    Optional<InventoryItem> findBySkuAndDeletedFalse(String sku);
    List<InventoryItem> findByFarmIdAndCategory_NameContainingIgnoreCaseAndDeletedFalse(UUID farmId, String categoryName);
}
