...
export default function FarmDetailScreen() {
  ...
  const areaInfo = calculateFarmArea(farm.boundary);
            ...
            <div className="flex items-end gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5 text-xs text-muted-foreground">
                  ...
                  {areaInfo.acres > 0 && <span>({areaInfo.acres} acres / {areaInfo.hectares} ha)</span>}
                </div>
              </div>
            </div>
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sf-stagger">
          <div className="lg:col-span-2 space-y-6">
            {/* Interactive Farm Boundary Map */}
            <div className="sf-card p-5 space-y-3">
              <h3 className="text-sm font-semibold text-foreground flex items-center gap-2">
                <MapIcon className="w-4 h-4 text-primary" /> Farm Boundary & Geofence
              </h3>
              <FarmBoundaryMap
          ...
          <div className="space-y-6">
            <div className="sf-card p-5">
              <h3 className="text-sm font-semibold text-foreground mb-4 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-muted-foreground" /> Location & Coordinates
              </h3>
              <div className="space-y-3 text-sm">
                ...
                <div>
                  <p className="text-xs text-muted-foreground mb-0.5">Geographic Centroid</p>
                  <p className="font-mono text-xs font-medium text-foreground">
                    {farm.latitude ? `${farm.latitude.toFixed(6)}, ${farm.longitude?.toFixed(6)}` : 'N/A'}
                  </p>
                </div>
              </div>
            </div>
