        ...
        <div className="space-y-5 bg-muted/20 border border-border/40 p-4.5 rounded-xl text-xs">
          <div className="space-y-3.5">
            ...
            {task.actualCost != null && (
              <div className="flex items-center justify-between border-t border-border/50 pt-3">
                <span className="font-semibold text-muted-foreground">{isTa ? 'செலவு' : 'Actual Cost'}:</span>
                <span className="font-bold text-foreground">${task.actualCost.toFixed(2)}</span>
              </div>
            )}
            
            {task.gpsLocation && (
              <div className="flex items-center justify-between">
                <span className="font-semibold text-muted-foreground">GPS Location:</span>
                <span className="font-bold text-foreground text-[10px] break-all max-w-[120px] text-right">{task.gpsLocation}</span>
              </div>
            )}
