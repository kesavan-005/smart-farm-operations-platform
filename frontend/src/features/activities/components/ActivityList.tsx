...
export default function ActivityList({ 
  ...
  const getProgress = (activityId: string) => {
    ...
    return Math.round((completed / activityTasks.length) * 100);
  };
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-16 h-1.5 bg-muted rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${getProgress(act.id)}%` }} 
                          />
                        </div>
                        <span className="text-[10px] text-muted-foreground font-semibold">{getProgress(act.id)}%</span>
                      </div>
                    </td>
                    <td className="p-3 text-xs text-muted-foreground">
