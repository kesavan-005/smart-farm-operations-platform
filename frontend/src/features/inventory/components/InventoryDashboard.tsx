      ...
      */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="sf-card p-6 border border-border bg-background">
          <h3 className="text-sm font-bold text-foreground mb-4">{t('stockValueByWarehouse')}</h3>
          <div className="h-64">
        ...
        {/* Chart 2 */}
        <div className="sf-card p-6 border border-border bg-background">
          <h3 className="text-sm font-bold text-foreground mb-4">{t('stockCountByCategory')}</h3>
