...
export default function HelpScreen() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'The Smart Farm platform analyzes satellite imagery and soil characteristics to suggest optimal recommendations. AI features will be fully activated in Phase 4.'
    }
  ];
